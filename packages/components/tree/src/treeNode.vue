...
import SpCheckbox from '@sp-ui/components/checkbox';
import Switcher from '@sp-ui/components/internal-icon/Switcher';
import Loading from '@sp-ui/components/internal-icon/Loading';
